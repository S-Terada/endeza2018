...
def p1(mas, new):
    ...
    if new[7][1] < new[6][1] and new[7][1] < new[4][1]:
        constant = 0
    else:
        constant = 9999999

    ans = (abs((mpans1 - npans1)) + abs((mpans2 - npans2))+constant) / 2
    print("key 2 is " + str(ans))
    return ans
...
def p2(mas, new):
    ...
    # additional condition determination
    if new[4][1] < new[3][1] and new[4][1] < new[7][1]:
        constant = 0
    else:
        constant = 999999

    ans = (abs((mpans1 - npans1)) + abs((mpans2 - npans2))+constant) / 2
    print("key 1 is " + str(ans))
    return ans
...
def p4(mas, new):
    ...
    # additional condition determination   #checked
...
def p9(mas, new):
    ...
    # additional condition determination
    if new[4][1] < new[3][1] and new[7][1] < new[6][1] and new[7][1] < new[3][1]:
        constant = 0
    else:
        constant = 9999999

    ans = (preans1 + preans2 + constant) / 2
    print("key 9 is " + str(ans))
    return ans
